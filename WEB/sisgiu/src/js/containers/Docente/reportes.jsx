...
class ReporteDocente extends Component {
    ...
    return request
      .post(host + 'api/reporte/periodo/'+this.props.activeUser.user.usuario.cedula+'/')
...
export default connect(mapStateToProps, mapDispatchToProps)(ReporteDocente);
