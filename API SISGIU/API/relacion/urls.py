...
urlpatterns = format_suffix_patterns([
    ...
    url(r'^api/estudianteAsignatura/modificarInscripcion/(?P<cedula>[0-9]{6,8})/$',
        EstudianteAsignaturaListCreateAPIView.modificar_estudiante_asignatura,
        name='EstudianteAsignatura-update'),
