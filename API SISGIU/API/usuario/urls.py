...
urlpatterns = format_suffix_patterns([
    ...
    url(r'^api/usuarios/(?P<modulo>[\w\-]+)/$', AdministradorListCreateAPIView.get_usuarios, name='usuario-list'),
    ...
    url(r'^api/usuarios/(?P<username>\d+)/delete/$', AdministradorDeleteAPIView.as_view(), name='usuario-delete'),
    ...
    url(r'^api/docentes/(?P<cedula>\d+)/cambiarDocumento/(?P<tipo_documento>[\w\-]+)/$', DocenteDetailAPIView.update_file, name='docente-archivo'),
